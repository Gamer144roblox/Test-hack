...
local Window = OrionLib:MakeWindow({Name = "Gamer144 Hub V4", HidePremium = false, IntroText = "Heloo", SaveConfig = true, ConfigFolder = "Gamer144 Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Gamer144 Hub Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
