...
ImageButton1.Image = "http://www.roblox.com/asset/?id=16486409560"
...
function Update:Window(text,logo,keybind)
    ...
    MapName.TextColor3 = Color3.fromRGB(0, 128, 128)   
    ...
    Hubb.Name = "Hubb"
    Hubb.Parent = Top
    Hubb.BackgroundColor3 = Color3.fromRGB(0, 128, 128)
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id=16486409560"..tostring(16486409560)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(16486409560)
...
H:AddLabel("[+] Send Notifications Kisune Spwan (There is a warning sound )|14/1/2567|08:08")
...
_G.FastMode = "Normal"
Main:AddDropdown("Select Fast Mode",fast,function(value)
	_G.FastMode = value
end)
...
_G.FastModeD = "Safety"
Main:AddDropdown("Select Fast Delay",SFast,function(value)
	_G.FastModeD = value
end)
	...
	while task.wait(.1) do
		local ac = CombatFrameworkR.activeController
		if ac and ac.equipped then
			if FastAttack and _G.FastAttack and _G.FastMode == "Normal" then
				AttackFunction()
				if _G.FastModeD == "Fast" then
					if tick() - cooldownfastattack > .9 then wait(.1) cooldownfastattack = tick() end
				elseif _G.FastModeD == "Extra" then
					if tick() - cooldownfastattack > 1.5 then wait(.01) cooldownfastattack = tick() end
				elseif _G.FastModeD == "Safety" then
...
coroutine.wrap(function()
	while task.wait(.1) do
		local ac = CombatFrameworkR.activeController
		if ac and ac.equipped then
			if FastAttack and _G.FastAttack and _G.FastMode == "NoCDAttack" then
				AttackNoCD()
				if _G.FastModeD == "Fast" then
					if tick() - cooldownfastattack > .9 then wait(.1) cooldownfastattack = tick() end
				elseif _G.FastModeD == "Extra" then
...
M:AddToggle("Auto Quest Shipwinght Teacher",_G.GetQuaetRepia,function(value)
