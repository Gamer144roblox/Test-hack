...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---- Thông Báo Mới
require(game.ReplicatedStorage:WaitForChild("Notification")).new("<Color=Red>Welcome To Gringo Hub | Version 3.7 Premium<Color=/>"):Display()
---- Kết Khúc
wait(5)
--- Bảng Thông Báo Update
...
--------------------------------------------------------------------
local Library = Update:Window("Gringo","")
------------------------------------------
...
--------------------------
local Info = Library:Tab("Developer","rbxassetid://13994827329")
...
Info:Label1("Hey Bro, " ..game.Players.LocalPlayer.Name.. " Welcome To Gringo Hub!")
Info:Label("Script Blox Fruit Bypass Antiban Now. | Thanks You.")
Info:Seperator(" Info Developer ")
Info:Button("Developer By Le Van Nhat",function()
setclipboard("Developer By Le Van Nhat | Discord: Le Van Nhat#5759")
end)
Info:Button("Discord Sever",function()
setclipboard("https://discord.gg/v9uAxHRHbz")
end)
Info:Button("YouTube Owner",function()
setclipboard("https://youtube.com/@LeNhatMediaEntertainment")
end)
Info:Button("Instagram Owner",function()
setclipboard("https://instagram.com/levannhat.dev?igshid=ZDc4ODBmNjlmNQ==")
end)
Info:Button("Tik Tok Owner",function()
setclipboard("https://tiktok.com/@vadaylalevanhatdz")
end)
Info:Button("Website Gringo Hub",function()
setclipboard("https://levanhatdev.sacmau.mobi")
end)
Info:Seperator(" Donate Me ")
Info:Button("Donate Momo",function()
setclipboard("https://me.momo.vn/tabotrandonate")
end)
------ Kết Khúc
...
Race:Seperator("Race V4")
    ...
    Race:Toggle("Auto Comple Trial Race V4", nil, function(value)
